...
// Startup code for the executable 'adc_mcp9700'.
...
LE_SHARED const char* _ADC_MCP9700Component_le_adc_ServiceInstanceName = "adc_mcp9700.ADC_MCP9700Component.le_adc";

// Define default component's log session variables.
LE_SHARED le_log_SessionRef_t adc_mcp9700_exe_LogSession;
LE_SHARED le_log_Level_t* adc_mcp9700_exe_LogLevelFilterPtr;
...
int main(int argc, char* argv[])
{
    ...
    adc_mcp9700_exe_LogSession = log_RegComponent("adc_mcp9700_exe", &adc_mcp9700_exe_LogLevelFilterPtr);
    ...
    LoadLib("libComponent_ADC_MCP9700Component.so");
